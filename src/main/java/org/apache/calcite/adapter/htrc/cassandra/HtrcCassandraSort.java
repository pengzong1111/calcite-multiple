 ...
 */
public class HtrcCassandraSort extends Sort implements HtrcCassandraRel {
  public HtrcCassandraSort(RelOptCluster cluster, RelTraitSet traitSet,
  ...
  @Override public Sort copy(RelTraitSet traitSet, RelNode input,
    ...
    return new HtrcCassandraSort(getCluster(), traitSet, input, collation);
  }
