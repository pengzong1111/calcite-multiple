...
//	  System.out.println("call current");
//	  System.out.println("fieldTypes.size(): " + fieldTypes.size());
	  Object[] rowValues = new Object[fieldTypes.size()];
	  for (int i = 0; i < fieldTypes.size(); i++) {
		  rowValues[i] = currentRowField(i, fieldTypes.get(i).getType().getSqlTypeName());
...
//	  System.out.println("call moveNext");
    if (iterator.hasNext()) {
      current = iterator.next();
//      System.out.println(current.getString("country"));
      return true;
    } else {
      return false;
    }
