...
public class HtrcCassandraProject extends Project implements HtrcCassandraRel {
  public HtrcCassandraProject(RelOptCluster cluster, RelTraitSet traitSet,
      RelNode input, List<? extends RexNode> projects, RelDataType rowType) {
    super(cluster, traitSet, input, projects, rowType);
    System.out.println("===========cassandra adapter: CassandraProject CassandraProject=============");
  ...
  @Override public Project copy(RelTraitSet traitSet, RelNode input,
	  ...
	  System.out.println("===========cassandra adapter: CassandraProject copy=============");
  ...
  public void implement(Implementor implementor) {
	  System.out.println("===========cassandra adapter: CassandraProject implement============= " + implementor.getClass().getCanonicalName());
    implementor.visitChild(0, getInput());
    final HtrcCassandraRules.RexToCassandraTranslator translator =
        new HtrcCassandraRules.RexToCassandraTranslator(
            (JavaTypeFactory) getCluster().getTypeFactory(),
            HtrcCassandraRules.cassandraFieldNames(getInput().getRowType()));
