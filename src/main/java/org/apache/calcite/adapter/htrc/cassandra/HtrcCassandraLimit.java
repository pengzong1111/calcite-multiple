 ...
 */
public class HtrcCassandraLimit extends SingleRel implements HtrcCassandraRel {
  public final RexNode offset;
  public final RexNode fetch;

  public HtrcCassandraLimit(RelOptCluster cluster, RelTraitSet traitSet,
  ...
  @Override public HtrcCassandraLimit copy(RelTraitSet traitSet, List<RelNode> newInputs) {
    return new HtrcCassandraLimit(getCluster(), traitSet, sole(newInputs), offset, fetch);
  }
