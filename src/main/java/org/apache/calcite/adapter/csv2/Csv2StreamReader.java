 ...
 */
class Csv2StreamReader extends CSVReader implements Closeable {
  ...
  Csv2StreamReader(Source source) {
    this(source,
   ...
   */
  private Csv2StreamReader(Source source, char separator, char quoteChar,
