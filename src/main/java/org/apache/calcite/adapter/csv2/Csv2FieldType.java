...
enum Csv2FieldType {
  ...
  private static final Map<String, Csv2FieldType> MAP =
    new HashMap<String, Csv2FieldType>();

  static {
    for (Csv2FieldType value : values()) {
      MAP.put(value.simpleName, value);
    }
  }

  Csv2FieldType(Primitive primitive) {
    this(primitive.boxClass, primitive.primitiveClass.getSimpleName());
  }

  Csv2FieldType(Class clazz, String simpleName) {
    this.clazz = clazz;
  ...
  public static Csv2FieldType of(String typeString) {
