...
public class CsvTableScan extends TableScan implements EnumerableRel {
  ...
  protected CsvTableScan(RelOptCluster cluster, RelOptTable table,
    ...
    this.fields = fields;
    System.out.println("~~~~~~~~~~~~~~~~~~~fields null? " + (fields.length));
    System.out.println("--------------csv table scan new---------------");
    assert csvTable != null;
  }

  @Override public RelNode copy(RelTraitSet traitSet, List<RelNode> inputs) {
    assert inputs.isEmpty();
    System.out.println("--------------csv table scan copy---------------");
  ...
  @Override public RelDataType deriveRowType() {
	  System.out.println("--------------csv table scan deriveRowType---------------");
  ...
  @Override public void register(RelOptPlanner planner) {
	  System.out.println("--------------csv table scan register---------------");
